function sig = sbxpullsignalspackedBird(varargin)
% varargin{1} - movie name, i.e.: 'yel10_4052015_007' 
% varagin{2} - flag - use the alignment file or not
